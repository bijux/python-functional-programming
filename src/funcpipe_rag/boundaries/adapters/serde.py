"""Module 05 serialization contracts: Envelope + JSON/MessagePack + migrations (end-of-Module-09; adapters)."""

from __future__ import annotations

from dataclasses import dataclass
from typing import Any, BinaryIO, Callable, Iterable, Iterator, Mapping, Tuple, TypeAlias, TypeVar, cast
import json
...
def to_msgpack(x: T, enc: Encoder[T]) -> bytes:
    env = enc(x)
    return cast(bytes, msgpack.packb({"tag": env.tag, "ver": env.ver, "payload": env.payload}, **_MP_PACK))
