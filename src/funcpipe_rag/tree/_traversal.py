"""Stack-safe, fully-lazy traversal of TreeDoc (end-of-Module-07)."""
...
def flatten_via_fold(tree: TreeDoc) -> Iterator[ChunkWithoutEmbedding]:
    ...
    def step(acc: list[ChunkWithoutEmbedding], node: TreeDoc, depth: int, path: Path) -> list[ChunkWithoutEmbedding]:
