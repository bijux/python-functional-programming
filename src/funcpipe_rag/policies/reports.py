"""Structured error reports from Result streams (end-of-Module-06)."""
...
from funcpipe_rag.result import Err, ErrInfo, Ok, Result
...
def report_to_jsonable(report: ErrReport[E]) -> dict[str, Any]:
    ...
    return {
        ...
        "by_path_prefix": {".".join(map(str, k)): group_to_jsonable(v) for k, v in report.by_path_prefix.items()},
    }
