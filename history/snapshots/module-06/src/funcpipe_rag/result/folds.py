"""Aggregation folds over Result streams (end-of-Module-06)."""
...
def fold_results_fail_fast(xs: Iterable[Result[T, E]], init: A, fn: Callable[[A, T], A]) -> Result[A, E]:
...
def fold_results_collect_errs(xs: Iterable[Result[T, E]], init: A, fn: Callable[[A, T], A]) -> Result[A, list[E]]:
