"""Module 09 Core 1: stdlib-first RAG composition examples (end-of-Module-09).
...
It intentionally reuses the existing pure stage functions from `funcpipe_rag.rag.stages`.
"""
