"""Module 09 Core 6: config overrides and CLI-friendly spec handling (end-of-Module-09).
...
def apply_step_params(cfg: PipelineConfig, step_name: str, params: dict[str, Any]) -> PipelineConfig:
