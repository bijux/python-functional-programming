"""Module 05 functors: curried mapping over Option, Result, and sequences (end-of-Module-07)."""
...
def result_bimap(f: Callable[[T], U], g: Callable[[E], F]) -> Callable[[Result[T, E]], Result[U, F]]:
